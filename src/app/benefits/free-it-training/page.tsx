        ...
        <div className="mt-20 pt-16 border-t border-white/10">
          ...
          <div className="bg-white/5 backdrop-blur-md rounded-3xl p-8 border border-white/10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                { icon: "💰", title: "Good Remuneration", desc: "Competitive pay per class + performance bonus" },
                { icon: "🏠", title: "Work from Home", desc: "Teach online from anywhere in India" },
                { icon: "📈", title: "Growth Opportunity", desc: "Become senior faculty & mentor new teachers" }
              ].map((benefit, i) => (

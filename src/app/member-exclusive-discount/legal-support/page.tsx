    ...
    <section className="relative w-full min-h-screen py-20 px-4 sm:px-6 lg:px-8 overflow-hidden bg-gradient-to-br from-slate-900 via-gray-900 to-black">
      ...
      <div className="relative z-10 max-w-5xl mx-auto">
        ...
        <div className="text-center mt-12">
          <button 
            onClick={() => alert("Consultation booking will open soon!")}
            className="bg-gradient-to-r from-purple-500 to-violet-500 text-white px-10 py-4 rounded-full font-bold text-lg hover:from-purple-600 hover:to-violet-600 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl"
          >
            Book Consultation
          </button>

      ...
      <div className="relative z-10 max-w-5xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Quality Care Medicines - Get authentic medicines at exclusive discounts.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
          ...
          <div className="bg-white/5 backdrop-blur-md rounded-2xl p-6 border border-white/10 hover:border-green-400/30 transition-all duration-300">
            <h2 className="text-2xl font-bold text-green-400 mb-4">💊 Medicine Benefits</h2>
          ...
          <div className="bg-white/5 backdrop-blur-md rounded-2xl p-6 border border-white/10 hover:border-green-400/30 transition-all duration-300 md:col-span-2">
            <h2 className="text-2xl font-bold text-green-400 mb-4">📝 How to Order</h2>
        ...
        <div className="text-center mt-12">
          <button 
            onClick={() => alert("Medicine ordering will open soon!")}
          ...
          <p className="text-gray-400 text-sm mt-4">Up to 70% off • Free delivery</p>
        </div>
      </div>
    </section>
  );

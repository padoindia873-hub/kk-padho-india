...
export default function ScholarshipApplyPage() {
  ...
  return (
    <section className="min-h-screen w-full py-8 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative mb-12 sm:mb-16">
          <div className="absolute inset-0 bg-gradient-to-r from-indigo-400/20 to-purple-400/20 rounded-2xl sm:rounded-3xl blur-2xl"></div>
          <div className="relative text-center px-4">
            <div className="inline-flex items-center justify-center w-20 h-20 sm:w-24 sm:h-24 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-2xl mb-4 sm:mb-6 shadow-xl">
              <span className="text-4xl sm:text-5xl">🎓</span>
            </div>
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-3 sm:mb-4 bg-gradient-to-r from-indigo-700 via-purple-700 to-pink-700 bg-clip-text text-transparent">
              Apply for Scholarship
            </h1>
            <div className="w-20 h-0.5 sm:w-24 bg-gradient-to-r from-indigo-400 to-purple-500 mx-auto mb-4 sm:mb-6 rounded-full"></div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 mb-12 sm:mb-16">
          ...
          <div className="group relative bg-white rounded-xl sm:rounded-2xl p-6 sm:p-8 shadow-xl hover:shadow-2xl transition-all duration-500 border border-indigo-100 hover:border-indigo-300">
            <div className="absolute inset-0 bg-gradient-to-br from-indigo-50 to-purple-50 rounded-xl sm:rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
            <div className="relative">
              <div className="w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-xl flex items-center justify-center mb-4 sm:mb-6 shadow-lg">
          ...
          <div className="group relative bg-white rounded-xl sm:rounded-2xl p-6 sm:p-8 shadow-xl hover:shadow-2xl transition-all duration-500 border border-indigo-100 hover:border-indigo-300">
            ...
            <div className="relative">
              ...
              <div className="mt-4 p-2 sm:p-3 bg-gradient-to-r from-indigo-50 to-purple-50 rounded-lg sm:rounded-xl border border-indigo-200 text-center">
        ...
        {/* Application Form */}
        <div className="bg-white rounded-xl sm:rounded-2xl shadow-2xl border border-indigo-100 overflow-hidden">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6">
              ...
              <div>
                ...
                <input 
                  ...
                  className="w-full px-3 sm:px-4 py-2.5 sm:py-3 bg-gray-50 border border-gray-200 rounded-lg sm:rounded-xl focus:border-indigo-400 focus:outline-none focus:ring-2 focus:ring-indigo-200 transition-all text-gray-800 text-sm sm:text-base placeholder:text-gray-400"
              ...
              <div>
                ...
                <input 
                  ...
                  value={formData.dob} 
                  onChange={handleChange} 
                  className="w-full px-3 sm:px-4 py-2.5 sm:py-3 bg-gray-50 border border-gray-200 rounded-lg sm:rounded-xl focus:border-indigo-400 focus:outline-none focus:ring-2 focus:ring-indigo-200 transition-all text-gray-800 text-sm sm:text-base"
                />
              </div>
              ...
              <div>
                <label className="block text-gray-700 font-semibold mb-2 text-sm sm:text-base">
                  Qualification <span className="text-indigo-500">*</span>
                </label>
                <select 
                  name="qualification" 
                  required 
              ...
              <div>
                <label className="block text-gray-700 font-semibold mb-2 text-sm sm:text-base">
                  Institution/College <span className="text-indigo-500">*</span>
                </label>
                <input 
                  type="text" 
                  name="institution" 
              ...
              <div>
                <label className="block text-gray-700 font-semibold mb-2 text-sm sm:text-base">
                  Course/Stream <span className="text-indigo-500">*</span>
                </label>
                <input 
                  type="text" 
                  name="course" 
              ...
              <div>
                <label className="block text-gray-700 font-semibold mb-2 text-sm sm:text-base">
                  Percentage/GPA <span className="text-indigo-500">*</span>
                </label>
                <input 
                  type="text" 
                  name="percentage" 
              ...
              <div>
                <label className="block text-gray-700 font-semibold mb-2 text-sm sm:text-base">
                  Annual Family Income <span className="text-indigo-500">*</span>
                </label>
                <select 
                  name="income" 
                  required 
          ...
          <div className="bg-gradient-to-r from-indigo-50 to-purple-50 px-6 sm:px-8 py-4 border-t border-indigo-100">

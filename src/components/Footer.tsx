...
export default function Footer() {
  return (
    <footer className="w-full bg-gradient-to-br from-blue-900 to-blue-800 text-white pt-16 pb-8 px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <div className="flex gap-3 mt-6">
              <a href="#" className="w-10 h-10 bg-blue-700 rounded-full flex items-center justify-center hover:bg-yellow-400 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/services" className="text-blue-200 hover:text-yellow-400 transition-colors">Services</Link></li>
              <li><Link href="/committee" className="text-blue-200 hover:text-yellow-400 transition-colors">Committee</Link></li>
            </ul>
          </div>
          ...
          {/* Bengali Quote */}
          <div>
            <h3 className="text-lg font-semibold mb-4 text-yellow-400">আমাদের অঙ্গীকার</h3>
            <p className="text-blue-200 text-sm leading-relaxed italic border-l-4 border-yellow-400 pl-4">
            ...
            <p className="text-white text-sm mt-2 font-semibold">
              Let us build the future of our children together.
            </p>
          </div>
        </div>

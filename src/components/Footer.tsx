        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold text-white">KK PADHO INDIA</span>
            </div>
          ...
          <div>
            ...
            <p className="text-gray-300 text-sm leading-relaxed italic border-l-4 border-blue-400 pl-4">
              Let us come together to build the future of our children, 
              who are the resources of our country, the pillars of our nation, 
            ...
            <div className="mt-4">
              ...
              <div className="flex">
                ...
                />
                <button className="bg-blue-500 text-white px-3 py-2 rounded-r-lg text-sm hover:bg-blue-600 transition-colors">
                  Go
                </button>
              </div>
            </div>
        ...
        <div className="border-t border-gray-700 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex gap-4 mt-4 md:mt-0">
              <Link href="/privacy" className="text-gray-400 text-sm hover:text-blue-400 transition-colors">Privacy Policy</Link>
              <Link href="/terms" className="text-gray-400 text-sm hover:text-blue-400 transition-colors">Terms of Service</Link>
              <Link href="/faq" className="text-gray-400 text-sm hover:text-blue-400 transition-colors">FAQ</Link>
            </div>
          </div>
        </div>
      </div>
